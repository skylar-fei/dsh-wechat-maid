 ...
 * and the error-message extractor. All copy stays in the locale dictionaries.
 */
import { en, t, zh, type WeixinKey } from './locales.ts'
...
export function tt(key: WeixinKey, values?: TranslateValues): string {
