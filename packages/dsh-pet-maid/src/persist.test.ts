  ...
  it('round-trips a saved persist file', () => {
    ...
    try {
      const data = {
        ...
        stats: { ...emptyStats(), totalTurns: 5, todayTurns: 2, model: 'deepseek-v4-pro', todayInputTokens: 1000, todayOutputTokens: 500, todayCacheReadTokens: 4000, todayCacheWriteTokens: 100 },
        autoCoding: true,
      }
